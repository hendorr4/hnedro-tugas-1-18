...
document.getElementByI("button_jumlah").onclick = function(){
    angka_1 = document.getElementByIda("angka_1").value;
    console.log(`angka_1 = ${angka_1} tipe = ${typeof angka_1}`);
    angka_2 = document.getElementByIda("angka_2").valueAsNumber;
